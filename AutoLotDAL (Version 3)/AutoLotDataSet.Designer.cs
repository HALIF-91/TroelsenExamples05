            ...
            public string Make {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Make\' в таблице \'Inventory\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string Color {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Color\' в таблице \'Inventory\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string PetName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'PetName\' в таблице \'Inventory\' равно DBNull.", e);
                    }
                }
                set {
...
namespace AutoLotDAL.AutoLotDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustId] = @CustId, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([CustId] = @Original_CustId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Orders] ([OrderID], [CustID], [CarID]) VALUES (@OrderID, @Cust" +
                "ID, @CarID);\r\nSELECT OrderID, CustID, CarID FROM Orders WHERE (OrderID = @OrderI" +
                "D)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Orders] SET [OrderID] = @OrderID, [CustID] = @CustID, [CarID] = @CarID WHERE (([OrderID] = @Original_OrderID) AND ([CustID] = @Original_CustID) AND ([CarID] = @Original_CarID));
